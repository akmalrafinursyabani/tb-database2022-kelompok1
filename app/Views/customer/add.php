                            ...
                            <form action="<?php echo base_url('/customer/create') ?>" method="POST">
                                ...
                                <div class="card-body table-responsive p-0">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="address" required class="form-control" id="exampleInputEmail1" placeholder="Jl. Andreas Undiaga No.41B RT04/22">
                                    </div>
                                    <button type="submit" class="btn btn-primary mt-3">Tambah Data pelanggan</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card-body -->
