                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('/customer/' . $item['id'] . '/update') ?>" method="POST">
                                <?= csrf_field() ?>
                                ...
                                <div class="card-body table-responsive p-0">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="address" value="<?= esc($item['address']) ?>" required class="form-control" id="exampleInputEmail1" placeholder="Jl. Andreas Undiaga No.41B RT04/22">
                                    </div>
                                    <button type="submit" class="btn btn-primary mt-3">Update Data pelanggan</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card-body -->
